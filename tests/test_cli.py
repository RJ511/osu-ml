...
@pytest.mark.parametrize("argv", [["collect"], ["status"], ["export"], ["maps"], ["sync-s3"], ["panel"], ["poll"], ["eval-log"], ["categorize"], ["dump-scores"], ["map-catalog"],
...
def test_every_subcommand_has_a_handler_and_poll_status_runs(tmp_path, monkeypatch, capsys):
    ...
    parser_commands = {"collect", "status", "export", "maps", "sync-s3", "panel", "poll", "categorize", "dump-scores", "map-catalog", "analyze", "dump-table", "recommend", "eval-log"}
